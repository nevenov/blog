...
<?php } ?>
        ...
        <div class="content-right">
            ...
            <div class="archives">
                ...
                $m = date("m");
                $y = date("Y");
				if(isset($OptionsVis["archive_num_mont"]) and $OptionsVis["archive_num_mont"]>1) {
					$archive_num_mont = $OptionsVis["archive_num_mont"];	
				} else {
					$archive_num_mont = 24;
				}
				
                for($i=0; $i<=$archive_num_mont; $i++) {
                    ...
                    if($count>0) {
                ?>
                    <li><a href="<?php echo $thisPage; ?>?ym=<?php echo date("Ym", mktime(0, 0, 0, $m-$i, 1, $y)); ?><?php echo $anchor_blt; ?>"><?php echo lang_date(date("F Y", mktime(0, 0, 0, $m-$i, 1, $y))); ?>(<?php echo $count; ?>)</a></li>
                    <?php
                    }
                 }
                ?>
