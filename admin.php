...
if (isset($_REQUEST["act"]) and $_REQUEST["act"]=='updateOptionsAdmin') {
	...
	$visual['archive_num_mont'] 	= $_REQUEST['archive_num_mont']; 
	...
	<table border="0" cellspacing="0" cellpadding="8" class="allTables">    
      ...
      <tr>
        ...
        <td class="left_top">
            ...
            Months in the past:
			<select name="archive_num_mont">
                <?php for($i=2; $i<=120; $i++) {?>
            	<option value="<?php echo $i;?>"<?php if($OptionsVis['archive_num_mont']==$i) echo ' selected="selected"'; ?>><?php echo $i;?>months</option>
                <?php } ?>
            </select> 
